...
export async function checkAsync(api: app.Server, urls: Array<string>, workAsync: Worker, options?: app.Options) {
...
async function urlAsync(api: app.Server, urls: Array<string>, workAsync: Worker, options?: app.Options) {

...
async function downloadAsync(this: app.Options, api: app.Server, series: app.api.LibraryContextSeries, sourceUrl?: string) {
...
async function tryUpdateAsync(api: app.Server, series: app.api.LibraryContextSeries, sourceUrl?: string, options?: app.Options) {
